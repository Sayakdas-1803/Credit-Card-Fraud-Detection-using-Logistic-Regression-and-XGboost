...
xgboost
rpart, rpart.plot
🧾 Conclusion Cost-sensitive learning significantly improves fraud detection in imbalanced datasets. While Logistic Regression offers interpretability, XGBoost captures complex fraud patterns more effectively, making it better suited for real-world deployment. M.Sc. Statistics, Presidency University
